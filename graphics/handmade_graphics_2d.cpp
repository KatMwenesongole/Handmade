...
struct render_information_primitive
{
    ...
    GLuint  shader;  // DO NOT CHANGE DIRECTLY
    GLuint texture;  // DO NOT CHANGE DIRECTLY
    v4      colour;  // DO NOT CHANGE DIRECTLY
...
inline internal void graphics_primitive_set_shader    (render_information_primitive* primitive, GLuint shader)              { primitive->shader       = shader;         } 
...
inline internal void graphics_primitive_set_font_glyph(render_information_font* font,
						       u8 character,
						       ...
						       r32 u1, r32 v1)
{
    if((character - ANSI_OFFSET) < 0) { return; }
...
#define graphics_set_viewport(param_width, param_height)	\
    glViewport(0, 0, (GLsizei)(param_width), (GLsizei)(param_height));
...
internal GLuint graphics_primitive_opengl_compileframebuffer(GLuint* colour_buffer, GLuint* depth_buffer, s32 width, s32 height)
{
...
internal void graphics_2d_initialise(render_information_primitive* primitive)
{
    //graphics_primitive_set_window_dimensions(primitive, primitive->window_width, primitive->window_height);
    ...
    primitive->primitive_shader = opengl_shader_compile_program(
    ...
    graphics_primitive_set_shader(primitive, primitive->primitive_shader);
}
...
internal void graphics_primitive_metrics_text (render_information_primitive* primitive, s8* text, s32 text_length, r32* max_width, r32* max_height)
{
    ...
    *max_height = ((py/(r32)primitive->window_height) * 9.0)*2;
}
