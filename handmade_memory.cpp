...
// internal memory_entry* memory_find_vacant      (memory_arena* Memory, u32 size)
// {
...
//     return(0);
// }
// internal memory_entry* memory_find_entry       (memory_arena* Memory, void* base)
// {
//     memory_entry* entry = (memory_entry*)Memory->base;
//     while(entry)
//     {
...
//     return(0);
// }
// internal memory_entry* memory_find_entry_before(memory_arena* Memory, void* base)
// {
//     memory_entry* entry = (memory_entry*)Memory->base;
//     while(entry)
//     {
...
// internal void* MEM_GET_SPACE(memory_arena* Memory, u32 size)
// {
...
//     return(0);
// }
// internal void  MEM_FREE_SPACE(memory_arena* Memory, void* base)
// {
...
internal void* stack_push(memory_arena* stack, u64 size)
{
    void* data = 0;
    if((stack->used + size) <= stack->size)
    {
	data = (s8*)stack->base + stack->used;
	stack->used += size;
    }
    return(data);
}
internal void stack_pop(memory_arena* stack, u64 size)
{
    if(stack->used)
    {
	stack->used -= size;
	mem_clear((s8*)stack->base + stack->used, size);
    }
}
