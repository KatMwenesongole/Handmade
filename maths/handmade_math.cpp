...
transform make_transform(v3 position, v3 rotation, v3 scale)
{
    transform t = {};
    t.position = position;
    t.rotation = rotation;
...
transform make_transform(r32 pos_x, r32 pos_y, r32 pos_z,r32 rot_x,r32 rot_y,r32 rot_z,r32 scale_x,r32 scale_y, r32 scale_z)
{
    transform t = {};

    v3 position = { pos_x, pos_y, pos_z };
    v3 rotation = { rot_x, rot_y, rot_z };
...
r32 calc_wrap(r32 n, r32 max, r32 min)
{
    ...
    // some wierd floating point percision problems
    //
    n = (n > max) ? min : n;
    n = (n < min) ? max : n;
