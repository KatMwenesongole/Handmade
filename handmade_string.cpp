...
#define HANDMADE_STRING_SMALL  32
#define HANDMADE_STRING_MEDIUM 64
#define HANDMADE_STRING_LARGE 256

struct string
{
    s8  s[HANDMADE_STRING_LARGE] = {};
	...
	mem_clear(s, HANDMADE_STRING_LARGE);
