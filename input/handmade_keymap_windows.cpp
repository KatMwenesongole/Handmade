...
// @ keyboard & mouse
internal void
windows_key_update (BYTE* keyboard_state, action_information* current, action_information* previous, action_choice choice, s32 windows_key, r32 magnitude)
{
...
internal void
windows_mouse_update(action_information* current, action_information* previous, HWND window, s32 window_width, s32 window_height)
{
...
// @ gamepad
internal void
windows_joystick_update(action_information* current, action_information* previous, action_choice choice, SHORT joystick)
{
...
internal void
windows_button_update(action_information* current, action_information* previous, action_choice choice, b32 down)
{
    action_state* state = &current->actions[choice];
...
internal void
windows_actions_update(HWND window, s32 window_width, s32 window_height, action_information* current, action_information* previous)
{
    *current = {};
